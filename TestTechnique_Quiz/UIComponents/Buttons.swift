...
struct AccentButton: ButtonStyle {
    func makeBody(configuration:Configuration) -> some View {
        ...
        configuration.label.font(.callout).fontWeight(.medium).multilineTextAlignment(.center).padding(30).frame(width: 300, height: 100).background(/*@START_MENU_TOKEN@*//*@PLACEHOLDER=View@*/Color("accent")/*@END_MENU_TOKEN@*/).foregroundColor(.purple).border(/*@START_MENU_TOKEN@*/Color.white/*@END_MENU_TOKEN@*/, width: /*@START_MENU_TOKEN@*/2/*@END_MENU_TOKEN@*/).cornerRadius(/*@START_MENU_TOKEN@*/5.0/*@END_MENU_TOKEN@*/).shadow(radius:0).scaleEffect(configuration.isPressed ? 0.9 : 1.0).animation(.easeOut(duration: 0.4), value: configuration.isPressed)
    }
}
...
struct UtilButtonStyle : ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label.padding(20).foregroundColor(.white).background(.blue).frame(width: 300, height: 100)
    }
}
